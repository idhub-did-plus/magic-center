...
public class CryptoUtils {
    ...
    public static Map<Integer, String> ecrecoverPersonalSignature(String signature, String message) {
       ...
       System.out.println("ecrecoverPersonalSignature(signature="+signature+", message="+message+")");
    ...
    public static Map<Integer, String> ecrecover(String signature, byte[] msgHash) {
       ...
       System.out.println("ecrecover(signature="+signature+", msgHash="+DatatypeConverter.printHexBinary(msgHash)+")");
         ...
         for(int i=0; i<4; i++) {
             ...
             System.out.println("publicKey ("+i+") = "+publicKey);
        ...
        System.out.println("checkSig(signature="+signature+", msgHash="+DatatypeConverter.printHexBinary(msgHash)+") => addresses recovered " + addresses);
