 ...
 * 
 * <p>
 * Producer : com.parse2.aparse.Parser 2.5<br/>
 * Produced : Fri Apr 19 22:09:52 CEST 2019
 * </p>
 */
...
public class ParserException extends RuntimeException {
	 ...
	 * @param index     The index to the character at which the parse failure
	 *                  occurred.
	...
	/**
	 * Returns a substring of the parsed string that encompasses the point at which
	 * the parse failure occurred. The substring will be up to 60 characters in
	 * length unless the point of failure occurred within 30 characters of the start
	 * or end of the parsed string. {@link #getSubstringIndex} returns an index to
	 * the character within this substring at which the parse failure occurred. This
	 * substring may contain non-printable characters.
	 *
	...
	/**
	 * Returns a message detailing the parse failure. The message detail the reason
	 * for the failure and where the failure occurred.
	 *
	 * <br>
	 * <br>
	 * For example ...<br>
