...
import com.idhub.magic.did.parser.Displayer;
import com.idhub.magic.did.parser.Parser;
import com.idhub.magic.did.parser.ParserException;
import com.idhub.magic.did.parser.Rule;
import com.idhub.magic.did.parser.Rule_did;
import com.idhub.magic.did.parser.Rule_did_url;
import com.idhub.magic.did.parser.Rule_fragment;
import com.idhub.magic.did.parser.Rule_param_name;
import com.idhub.magic.did.parser.Rule_param_value;
import com.idhub.magic.did.parser.Rule_path_abempty;
import com.idhub.magic.did.parser.Rule_query;
import com.idhub.magic.did.parser.Terminal_NumericValue;
import com.idhub.magic.did.parser.Terminal_StringValue;
...
public class DIDURL {
	...
	public static DIDURL fromString(String string, boolean keepParseTree)
	...
	private class DIDVisitor extends Displayer {
		...
		public Object visit(Rule_param_name rule) {
			...
			if (DIDURL.this.parameters == null)
	...
	public boolean equals(Object obj) {
		...
		if (obj == null || !(obj instanceof DIDURL))
			return false;
		if (obj == this)
			return true;
