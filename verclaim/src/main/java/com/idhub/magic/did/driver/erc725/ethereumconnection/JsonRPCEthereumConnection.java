package com.idhub.magic.did.driver.erc725.ethereumconnection;
...
import com.idhub.magic.did.driver.erc725.ERC725Contract;
...
public class JsonRPCEthereumConnection extends AbstractEthereumConnection implements EthereumConnection {
	...
	private static Web3j createWeb3j(final String url, final String username, final String password) {
