...
import com.idhub.magic.did.parser.Rule_method_name;
import com.idhub.magic.did.parser.Rule_method_specific_id;
...
public class DID {
	...
	public static DID fromString(String string, boolean keepParseTree)
