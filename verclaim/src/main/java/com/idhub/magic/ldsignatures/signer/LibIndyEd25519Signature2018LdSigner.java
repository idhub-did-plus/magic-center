...
public class LibIndyEd25519Signature2018LdSigner extends LdSigner<Ed25519Signature2018SignatureSuite> {
	...
	public LibIndyEd25519Signature2018LdSigner(URI creator, String created, String domain, String nonce, Wallet wallet,
			String signerVk) {
	...
	public static String sign(String canonicalizedDocument, Wallet wallet, String signerVk)
