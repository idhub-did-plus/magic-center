...
import com.idhub.magic.ldsignatures.suites.RsaSignature2018SignatureSuite;
...
public class RsaSignature2018LdValidator extends LdValidator<RsaSignature2018SignatureSuite> {
	...
	public static boolean validate(String canonicalizedDocument, LdSignature ldSignature, RSAPublicKey publicKey)
