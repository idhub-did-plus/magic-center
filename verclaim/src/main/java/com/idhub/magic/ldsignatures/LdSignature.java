package com.idhub.magic.ldsignatures;
...
public class LdSignature {
	...
	public static void addToJsonLdObject(LinkedHashMap<String, Object> jsonLdObject,
			LinkedHashMap<String, Object> jsonLdSignatureObject) {
	...
	public static LdSignature getFromJsonLdObject(LinkedHashMap<String, Object> jsonLdObject) {
		...
		LinkedHashMap<String, Object> jsonLdSignatureObject = (LinkedHashMap<String, Object>) jsonLdObject
				.get(JSONLD_TERM_PROOF);
