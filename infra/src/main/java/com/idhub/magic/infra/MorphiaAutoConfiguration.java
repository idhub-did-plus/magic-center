...
public class MorphiaAutoConfiguration {
    ...
    public Datastore datastore() {
        ...
        for (BeanDefinition candidate : entityScanner.findCandidateComponents("com.idhub.magic.infra.model")) { // from properties?
            try {
        ...
        return morphia.createDatastore(mongoClient, "InfraRepository"); // "dataStoreInstanceId" may come from properties?
    }
	@Bean
